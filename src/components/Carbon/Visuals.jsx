    ...
    return (
        <div>
            {vertical && (<div className = {styles.section}>
                ...
                <div className = {styles.npv}><span className = {styles.info}><i class="material-icons" onClick = {() => {setShowInfo(true);}}>info_outline</i>
            ...
            {showInfo && (
                <div className={styles.overlay}>
                    ...
                    <p>This is the cumulative net discounted CO2 emitted into the atmosphere per your scenario, valued from the perspective of emissions today. For example, at a 3.355% annual discount rate, 1 ton of CO2 emitted annually, indefinitely, has a net present value (NPV<sub>CO<sub>2</sub></sub>) of 30.8 tons of CO<sub>2</sub> emitted only once, today. The term “value” here is a proxy for “impact,” as quantity emitted, when those emissions occur, and the rate at which those emissions dissipate all contribute to the impact that CO2 in the atmosphere has on global radiative forcing (the greenhouse effect, global average temperature increase).</p>
